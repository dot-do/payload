...
export function sqliteDOAdapter(args: Args): DatabaseAdapterObj<SQLiteDOAdapter> {
  ...
  function adapter({ payload }: { payload: Payload }) {
    ...
    return createDatabaseAdapter<SQLiteDOAdapter>({
      name: 'sqlite',
      ...
      migrateStatus,
      migrationDir,
      packageName: '@payloadcms/db-do-sqlite',
      payload,
      queryDrafts,
      rejectInitializing,
      requireDrizzleKit,
...
export type {
  ...
  MigrateDownArgs,
  MigrateUpArgs,
  SQLiteDOAdapter as SQLiteAdapter,
  SQLiteSchemaHook,
} from './types.js'
